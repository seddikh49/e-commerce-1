...
const NewsLetter = () => {
  ...
  return (
    <div  className='text-center'>
     ...
     <form onSubmit={onSubmitHandler} action="" className='flex xl:w-4/9 sm:w-full lg:w-2/3  md:w-2/3  my-6 border mx-auto'>
        <input className='xl:w-1/2 text-xl font-poppins sm:w-full flex-1 pl-4 outline-none' type="email" placeholder='Enter your email' required />
